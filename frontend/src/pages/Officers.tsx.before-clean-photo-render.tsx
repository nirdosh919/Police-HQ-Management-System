...
function ViewOfficerModal({
  ...
  const photoUrl = officer.photograph ? (officer.photograph.startsWith("http") ? officer.photograph : `http://${window.location.hostname}:5000${officer.photograph.startsWith("/") ? "" : "/"}${officer.photograph}`) : "";
