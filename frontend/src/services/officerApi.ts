...
export async function getOfficers(
  ...
  const response = await fetch(`${API_BASE_URL}/officers?${query.toString()}`, {
...
export async function getOfficerById(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}`, { headers: getAuthHeaders() });
...
export async function updateOfficer(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}`,
    {
      method: "PUT",
...
export async function deleteOfficer(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}`, { method: "DELETE", headers: getAuthHeaders() });
...
export async function uploadOfficerFiles(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}/files`,
    {
...
export async function addOfficerPromotion(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}/promotions`,
    {
      method: "POST", headers: { "Content-Type": "application/json", ...getAuthHeaders() },
...
export async function deleteOfficerDocument(
  ...
  const response = await fetch(`${API_BASE_URL}/officers/${id}/documents/${documentIndex}`, { method: "DELETE", headers: getAuthHeaders() });
