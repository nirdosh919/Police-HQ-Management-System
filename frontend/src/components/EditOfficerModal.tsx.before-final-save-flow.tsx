...
export default function EditOfficerModal({
  ...
  const existingPhotoUrl = officer.photograph ? (officer.photograph.startsWith("http") ? officer.photograph : "http://localhost:5000" + (officer.photograph.startsWith("/") ? "" : "/") + officer.photograph) : "";
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      alert("Officer changes saved successfully.");
    } catch (error) {
